...
menu_def = [
    ['Arquivo de Imagem', ['Abrir Imagem','Thumbnail', 'Qualidade Reduzida', 'Escolher Formato', ['PNG', 'JPEG']]],
...
def main():
    ...
    layout = [
        [
            sg.Graph(key="-IMAGE-", canvas_size=(600,350), graph_bottom_left=(0, 0), graph_top_right=(400, 400), change_submits=True, drag_submits=True),
    ...
    window = sg.Window("Salvar Imagens", layout=layout)
    ...
    while True:
        ...
        if event == "Recortar":
            ...
            if(cord4 < cord2):
                ...
                nova_cord2 = cord2
                nova_cord4 = cord4
            crop_image(imagem, (nova_cord1, nova_cord2, nova_cord3, nova_cord4), "ImgRecortada.jpg")
            # print((nova_cord1, nova_cord2, nova_cord3, nova_cord4))
